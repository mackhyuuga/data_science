...
counts
table(dados$Genero)
frequencia_matrix = matrix(table(dados$Genero))
frequencia = table(dados$Genero)
frequencia = frequencia*100/(frequencia[[1]] + frequencia[[2]] + frequencia[[3]] + frequencia[[4]] + frequencia[[5]])
barplot(frequencia, main="Gêneros", xlab="Gêneros", ylab = 'frequency', )
frequencia
frequencia_matrix
```
